...
export class AppComponent {
  ...
  data: any = [ 
    ...
    { id: 11, name: 'Keshav', age: 20, weight: 20, gender: 1, phone: 7930343463, parent: 4},
    { id: 12, name: 'Kartik', age: 20, weight: 20, gender: 1, phone: 7930343463, parent: 11},
    { id: 13, name: 'Kanishk', age: 20, weight: 20, gender: 1, phone: 7930343463, parent: 12},
